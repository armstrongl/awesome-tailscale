...
- [almeidapaulopt/tsdproxy](https://github.com/almeidapaulopt/tsdproxy): Automatic reverse proxy for Docker containers on Tailscale with zero sidecars, label-based config, and automatic HTTPS.
