...
- [dzianisv/opencode-mobile](https://github.com/dzianisv/opencode-mobile): An open-source Android client for the OpenCode AI coding agent that connects to your self-hosted server over your tailnet.
