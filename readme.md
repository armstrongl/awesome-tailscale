...
- [lydakis/errand](https://github.com/lydakis/errand): Personal job runner that snapshots a worktree, runs a command on another machine over Tailscale or SSH, streams logs, and can fetch or apply changes back.
